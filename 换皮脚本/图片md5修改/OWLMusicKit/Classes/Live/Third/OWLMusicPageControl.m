...
@interface OWLMusicPageControl ()<OWLMusicPageControlDelegate>


@end


@interface OWLMusicPageControl ()

@property (nonatomic, strong) NSMutableArray *dots;

@end
@implementation OWLMusicPageControl
...
- (void)setPageAliment:(OWLMusicPageControlType)pageAliment{
