//
//  OWLMusicPageControl.h
//  OWLMusicPageControl
//
//  Created by xuanhe on 2022/9/2.
//  github:https://github.com/zxhkit/OWLMusicPageControl
...
typedef NS_ENUM(NSUInteger,OWLMusicPageControlType){
    PageControlMiddle = 0, //
    PageControlRight, //
    PageControlLeft //
};
...
@class OWLMusicPageControl;
@protocol OWLMusicPageControlDelegate <NSObject>
...
- (void)xh_PageControlClick:(OWLMusicPageControl*)pageControl index:(NSInteger)clickIndex;

@end
@interface OWLMusicPageControl : UIControl

/// 代理
@property (nonatomic, weak)     id<OWLMusicPageControlDelegate > delegate;
/// Block点击回调
@property (nonatomic, copy)     void (^clickPointBlock)(NSInteger index);


/// 控件位置,默认中间:PageControlMiddle
@property (nonatomic, assign)   OWLMusicPageControlType pageAliment;
